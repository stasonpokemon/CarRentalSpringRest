...
(
    ...
    order_status  INT CHECK ( order_status >= 0 AND order_status <= 3) NOT NULL DEFAULT 0,
    price         double precision                                     NOT NULL,
